...
<template>
  <header class="py-5 shadow-md">
    <div class="container m-auto flex justify-between">
      ...
      <div class="logo">
        <svg
id="Liniengrafik" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
...
d="M244.6,78.4c-0.4-0.4-0.8-0.6-1.4-0.6h-6.1c-1,0-1.8,0.5-2.3,1.5l-15.2,28.1l-16.1-28.1c-0.5-1-1.2-1.5-2.3-1.5H196
      ...
      <div class="user flex">
        <button @click="logout()" class='logout font-bold mr-2 bg-transparent border-0'>Log Out</button>
