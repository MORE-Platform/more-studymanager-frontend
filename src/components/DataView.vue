<script setup lang="ts">
  ...
  const kibanaUrl = study.value
    ? 'https://kibana.platform-test.more.redlink.io/app/dashboards#/view/90b3d4d0-6ef9-11ed-9d37-37f3957fa3f8?_g=(filters:!((query:(match_phrase:(study_id.keyword:study_' +
      study.value.studyId +
      ')))))'
...
<template>
  <div class="dataview container m-auto mt-10">
    <div>
      <span class="font-medium">Live Data Dashboard: </span>
